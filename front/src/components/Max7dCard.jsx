export default function Max7dCard({ data, CARD_WIDTH }) {
    ...
    const maxNivel7dias = (() => {
        ...
        for(let i = data.length - 2; i >= 0; i-- ) {
            if(data[i].date < dateOf7daysBefore)
                break;
        ...
        return {
            ...
            stringTime: `${String(dateOfMax.getDate()).padStart(2, "0")}/${String(dateOfMax.getMonth()).padStart(2, "0")} -${dateOfMax.getHours()}:${String(dateOfMax.getMinutes()).padStart(2, '0')}hs`
        }
      })()
  ...
  return (
    <div className="card me-2 p-1" style={{ width: CARD_WIDTH }}>
      <div className="card-header">
        <h6 className="card-title text-center">Pico 7 días</h6>
      </div>
