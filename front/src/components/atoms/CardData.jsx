...
function CardData({ title, children }) {
  return (
    <div className="mb-4 bg-neutral-50 dark:bg-neutral-600 shadow-md hover:shadow-lg transition-shadow duration-300 rounded-lg my-3">
      <div className="bg-neutral-200 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-100 rounded-t-lg p-2 border-b border-neutral-300 dark:border-neutral-600">
