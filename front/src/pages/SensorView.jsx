        ...
        <div className="container mt-5">
            <div id="main">
                ...
                <div id="content" className="d-flex justify-content-between align-items-start">
                    ...
                    <div id="card-container" className="d-flex align-items-center" style={{ height: CARD_HEIGHT }}>
                        <div className="card me-5 p-3">
                            <div className="card-body align-items-center">
                                <p className="card-text fs-3 d-flex">
                                    <div className="me-4">
                                        <i className="fa fa-tint me-2" aria-hidden="true" />1.3m
                                    </div>
                                    <div>
                        ...
                        <div className="card me-2 p-1" >
                            ...
                            <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                <p className="card-text fs-5">
                                    <div>
                                        <i className="fa fa-tint me-2" aria-hidden="true" />3.3m
                                    </div>
                                </p>
                        ...
                        <div className="card me-2 p-1">
                            ...
                            <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                ...
                                <p className="card-text fs-5">
                                    <div>
                                        <i className="fa fa-tint me-2" aria-hidden="true" />4.2m
                                    </div>
                                </p>
                        ...
                        <div className="card p-1">
                            ...
                            <div className="card-body d-flex flex-column justify-content-center align-items-center">
                                <p className="card-text fs-5">
                                    <div>
                                        <i className="fa fa-tint me-2" aria-hidden="true" />5.0m
                                    </div>
                                </p>
                                <h6 className="card-subtitle mb-2 text-body-secondary">04/10/2024 09:39</h6>
                            </div>
