...
const SensorForm = () => {
    ...
    const handleChange = (e) => {
        ...
        console.log(e.target.name, e.target.value); // debug
    };
    ...
    return (
        <div className="container-fluid mt-5 px-0" style={{ width: '100%' }}>
            <div className="card">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label htmlFor="porcentajeBateria" className="form-label">Porcentaje de Batería</label>
                            <input
                                type="number"
                                className="form-control"
                        ...
                        <MapaComponent onMapClick={handleMapClick} /> {/* Usa el componente de mapa */}
                    </form>
                </div>
            </div>
